...
const DrewHomepage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      <a
        href="https://wa.me/593958699845"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-4 shadow-2xl hover:shadow-xl transition-all duration-300 hover:scale-110"
        style={{ zIndex: 9999 }}
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div className="order-1 md:order-2">
              <h3 className="text-[28px] sm:text-[32px] lg:text-[38px] font-black text-gray-900 mb-6 tracking-tight uppercase" style={{ fontFamily: '"Mona Sans", system-ui, -apple-system, sans-serif' }}>
            ...
            <div>
              ...
              <div className="text-gray-700 leading-relaxed text-[17px] space-y-5">
                ...
                <div className="bg-white p-5 rounded-lg shadow-md mt-6">
                  ...
                  <p className="text-gray-700">Guayaquil, Ecuador</p>
                </div>
              </div>
            </div>
            <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[15px] text-white/80">Puerto Santa Ana, The Point</p>
                      <p className="text-[15px] text-white/80 mt-1">Guayaquil, Ecuador</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[15px] text-white/80">0958699845</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[15px] text-white/80">ventasdrew1@gmail.com</p>
                    </div>
                  </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.instagram.com/drewecuador?igsh=bGNncGN6enM1YWts" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 hover:bg-[#C9A55C] rounded-full flex items-center justify-center transition" aria-label="Instagram">
              ...
              <ul className="space-y-4 text-[15px]">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">Puerto Santa Ana, The Point</p>
                    <p className="text-white">Guayaquil, Ecuador</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">ventasdrew1@gmail.com</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">0958699845</p>
                  </div>
                </li>
              </ul>
            </div>
